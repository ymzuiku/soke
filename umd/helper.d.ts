export declare const min: (min: number) => (v: string) => ((k: string) => string) | undefined;
export declare const max: (max: number) => (v: string) => ((k: string) => string) | undefined;
/** 时间 */
...
/** 密码 */
export declare const password: (min?: number) => RegExp;
/** 账号 */
export declare const account: (min?: number, max?: number) => RegExp;
/** 国内座机 */
...
/** 国内身份证号 支持 15位和18位 */
export declare const cnId: () => RegExp;
/** 国内企业机构代码证 */
